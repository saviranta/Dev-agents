#!/bin/bash
# builder-composer/watch-api.sh — Anthropic API runner (no Claude Code CLI required)
# Launched via: shared/launch-api-agent.sh builder-composer PROJECT_NAME

AGENT="builder-composer"
SIGNAL_STATUS="done"   # builders and tester emit "done"; reviewers emit "reviewed"
